...
const playerNames = [nickname, 'Player2', 'Player3', 'Player4', 'Player5', 'Player6'];
...
function addPlayerAtRandomInterval() {
    if (currentPlayerIndex < playerNames.length && !hasRedirected) {
        const playerElement = document.createElement('div');
        playerElement.textContent = playerNames[currentPlayerIndex];
        playerElement.classList.add('player');
        playerElement.style.color = players[currentPlayerIndex].color;
